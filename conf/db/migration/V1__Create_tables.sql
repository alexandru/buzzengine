...
CREATE INDEX articles_select_idx ON buzz_articles USING btree (is_deleted, created_at);
...
CREATE INDEX personas_select_idx ON buzz_personas USING btree (is_deleted, created_at);
